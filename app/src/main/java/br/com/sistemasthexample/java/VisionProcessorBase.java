...
import br.com.sistemasthexample.CameraImageGraphic;
import br.com.sistemasthexample.FrameMetadata;
import br.com.sistemasthexample.GraphicOverlay;
import br.com.sistemasthexample.InferenceInfoGraphic;
import br.com.sistemasthexample.ScopedExecutor;
import br.com.sistemasthexample.TemperatureMonitor;
...
public abstract class VisionProcessorBase<T> implements VisionImageProcessor {
  ...
  private void processImage(
    ...
    if (isMlImageEnabled(graphicOverlay.getContext())) {
      ...
      requestDetectInImage(mlImage, graphicOverlay, bitmap, /* shouldShowFps= */ false, frameStartMs)
