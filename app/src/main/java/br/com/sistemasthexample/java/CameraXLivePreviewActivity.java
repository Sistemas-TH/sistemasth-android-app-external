...
import br.com.sistemasthexample.CameraXViewModel;
...
import br.com.sistemasthexample.java.barcodescanner.BarcodeScannerProcessor;
import br.com.sistemasthexample.java.facedetector.FaceDetectorProcessor;
import br.com.sistemasthexample.java.labeldetector.LabelDetectorProcessor;
import br.com.sistemasthexample.java.objectdetector.ObjectDetectorProcessor;
import br.com.sistemasthexample.java.posedetector.PoseDetectorProcessor;
import br.com.sistemasthexample.java.segmenter.SegmenterProcessor;
import br.com.sistemasthexample.java.facemeshdetector.FaceMeshDetectorProcessor;
import br.com.sistemasthexample.java.textdetector.TextRecognitionProcessor;
...
public final class CameraXLivePreviewActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cameraView = findViewById(R.id.constraintLayout_CameraX);
        resultView = findViewById(R.id.fullscreen_content);
        ...
        Log.d(TAG, "onCreate: PASSEEEEEEEEEEEEEEEI");
...
//        facingSwitch.setOnCheckedChangeListener(this);
        ...
        new ViewModelProvider((ViewModelStoreOwner) this, (ViewModelProvider.Factory) AndroidViewModelFactory.getInstance(getApplication()))
                ...
                .observe(
                        this,
                        provider -> {
                            Log.d(TAG, "bindingCameraProvider: PASSEEEEEEEEEEEEEEEI");
                            try {
...
//    }
    ...
    private void bindAnalysisUseCase() {
        ...
        if (targetResolution == null) {
            targetResolution = new Size(1080,1080);
        }
            builder.setTargetResolution(targetResolution);
...
//                    } catch (MlKitException e) {
    ...
    private void SpinningLoading() {
        ImageView loadingImageView = findViewById(R.id.fullscreen_content_image_X);
